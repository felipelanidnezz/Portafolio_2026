    ...
    >
      ...
      <div className="mt-14 flex flex-wrap items-center justify-center gap-5">
        <MagneticButton strength="strong" cursorText={t.hero.ctaProjects}>
          <a
            href="#proyectos"
            className="group relative overflow-hidden rounded-full bg-emerald-400 px-10 py-4 text-sm font-semibold text-black transition-colors hover:bg-emerald-300"
          >
        ...
        <MagneticButton cursorText={t.hero.ctaContact}>
          <a
            href="#contacto"
            className="rounded-full border border-zinc-600 px-10 py-4 text-sm font-semibold text-zinc-200 transition-colors hover:border-emerald-400/60 hover:text-white"
          >
            {t.hero.ctaContact}
          </a>
        </MagneticButton>
